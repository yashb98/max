...
window.max.sendAction("state_update", {
  currentView: "forecast",
  city: "Tokyo",
});

// Score changes during gameplay — track silently
window.max.sendAction("state_update", { score: 1250, lives: 2 });
