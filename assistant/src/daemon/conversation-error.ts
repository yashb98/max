...
// Managed usage-limit responses are generated by Max, even though they can
    ...
    if (error.statusCode === 429) {
      if (isManagedUsageLimitError(error, message)) {
        return {
          ...
          userMessage:
            "Max managed inference is rate limited. This is a Max-side usage limit, not an AI provider outage.",
          retryable: true,
