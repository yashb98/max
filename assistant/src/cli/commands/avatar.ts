...
Files are stored in $MAX_WORKSPACE_DIR/data/avatar/:
...
On success, writes avatar-image.png to $MAX_WORKSPACE_DIR/data/avatar/
...
$MAX_WORKSPACE_DIR/data/avatar/. character-ascii.txt is written on a
