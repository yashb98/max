...
/// Quick Look thumbnail provider for .max bundle files.
///
/// Extracts icon.png from the ZIP-based .max file for the thumbnail.
...
class ThumbnailProvider: QLThumbnailProvider {
    ...
    override func provideThumbnail(
        ...
        // Try extracting icon.png from the .max ZIP
