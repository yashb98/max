import SwiftUI
import MaxAssistantLib

@main
struct MaxAssistantApp: App {
    ...
    var body: some Scene {
        ...
        .commands {
            ...
            // say "Max" instead of the bundle display name (which may
            ...
            CommandGroup(replacing: .help) {
                ...
                Button("Discord Community") {
                    NSWorkspace.shared.open(URL(string: "https://www.max.ai/community?utm_source=macos-app&utm_medium=help-menu")!)
                }
                Divider()
