...
///
/// File: `~/Library/Application Support/max-assistant/debug-state.json`
///
...
final class DebugStateWriter {
    ...
    init(
        ...
        if let directory {
            ...
            dir = appSupport.appendingPathComponent(MaxEnvironment.current.appSupportDirectoryName, isDirectory: true)
        }
