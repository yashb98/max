...
struct OnboardingFlowView: View {
                        ...
                        switch state.currentStep {
                            ...
                            case 3:
                                ImproveExperienceStepView(
                                    ...
                                    onAccepted: state.selectedHostingMode == .maxCloud ? {
                                        Task {
                                            await performManagedBootstrap()
                                        }
                                    } : nil
    ...
    private func continueManagedOnboardingAfterAuthentication() async {
        ...
        // the user explicitly selects Max Cloud on the hosting selector.
        ...
        while clock.now < deadline {
            do {
                ...
                if response.isSuccess {
                    ...
                    // Inject client-resolvable max identity fields that
                    ...
                    if let organizationId = UserDefaults.standard.string(forKey: "connectedOrganizationId"),
                       !organizationId.isEmpty {
                        ...
                        log.warning("Skipping max identity injection — no cached organization id for \(assistantId, privacy: .public)")
                    }
