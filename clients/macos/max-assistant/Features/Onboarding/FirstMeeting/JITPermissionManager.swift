...
final class JITPermissionManager {
    ...
    private func alwaysAllowKey(for type: JITPermissionType) -> String {
        switch type {
        case .microphone:   return "com.max.jit.alwaysAllow.microphone"
        case .accessibility: return "com.max.jit.alwaysAllow.accessibility"
        case .screenCapture: return "com.max.jit.alwaysAllow.screenCapture"
        }
    }
