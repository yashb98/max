...
struct EarnCreditsModal: View {
    ...
    private var subtitleText: String {
        ...
        if referrerAmount == refereeAmount {
            return "Share Max with friends — you'll each earn \(referrerAmount) credits when they sign up, up to \(cap) total."
        } else {
            return "Share Max with friends — you'll earn \(referrerAmount) credits and they'll get \(refereeAmount) when they sign up, up to \(cap) total."
        }
    }
    ...
    private func termsContent(_ code: ReferralCodeResponse) -> some View {
        ...
        return VStack(alignment: .leading, spacing: VSpacing.lg) {
            ...
            VStack(alignment: .leading, spacing: VSpacing.md) {
                ...
                termsBullet("Rewards are earned once your invitee completes the creation of their Max account.")
