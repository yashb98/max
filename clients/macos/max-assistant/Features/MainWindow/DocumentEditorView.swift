...
struct DocumentEditorView: NSViewRepresentable {
    ...
    func makeNSView(context: Context) -> WKWebView {
        ...
        // Inject Max bridge for content change notifications
    ...
    static func dismantleNSView(_ webView: WKWebView, coordinator: Coordinator) {
        webView.configuration.userContentController.removeScriptMessageHandler(forName: "maxBridge")
    }
    ...
    private func loadEditorHTML(webView: WKWebView, title: String, content: String) {
        ...
        webView.loadHTMLString(html, baseURL: URL(string: "https://document.max.local/"))
    }
