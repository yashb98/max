...
struct AgentPanelContent: View {
    ...
    private static let createSkillURL = URL(string: "max://create-skill")!
    ...
    private var emptyStateSubtitle: String {
        ...
        switch skillsManager.skillFilter {
        case .all: return "Check your connection to the Max catalog."
        ...
        case .max: return "No bundled Max skills found."
    ...
    private var emptyStateIcon: String {
        ...
        case .max: return VIcon.package.rawValue
