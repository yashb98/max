...
/// assistant-scoped). Successful deletion only destroys the Max cloud
    ...
    var body: some View {
        VStack(spacing: VSpacing.xl) {
            VStack(spacing: VSpacing.md) {
                Text("Delete Max Account")
                    .font(VFont.bodySmallEmphasised)
                    .foregroundStyle(VColor.contentDefault)

                Text("This permanently deletes your Max cloud account and all data stored on Max. It cannot be undone.")
            ...
            HStack(spacing: VSpacing.md) {
                ...
                if isSubmitting {
                    ...
                    VButton(label: "Delete Max account", style: .danger) {
                        Task { _ = await submit() }
                    }
                    .accessibilityLabel("Delete Max account")
                }
            }
        }
        .padding(VSpacing.xl)
