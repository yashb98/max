...
/// feature cards, and a "More from Max" resource grid.
...
private struct CommunityHeroBanner: View {
    var body: some View {
        VStack(alignment: .leading, spacing: VSpacing.md) {
            ...
            Text("Max is built in the open with a growing community of developers, designers, and tinkerers. Here's how to get involved.")
...
private struct MoreFromMaxSection: View {
    var body: some View {
        VStack(alignment: .leading, spacing: VSpacing.lg) {
            Text("MORE FROM MAX")
                .font(VFont.labelDefault)
