...
struct SettingsGeneralTab: View {
    ...
    /// server-side LaunchDarkly flag in `max-assistant-platform`) and a
    ...
    private var dangerZoneSection: some View {
        SettingsCard(
            title: "Danger Zone",
            subtitle: "Permanently delete your Max account."
        ) {
    ...
    private var accountSectionSubtitle: String {
        ...
        if authManager.isValidationFailed { return "Reconnecting to Max..." }
