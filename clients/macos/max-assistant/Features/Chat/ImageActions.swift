...
enum ImageActions {
    ...
    @MainActor private static func ensureProbeFile(for key: String) -> URL {
        let probeURL = FileManager.default.temporaryDirectory.appendingPathComponent("max-share-probe.\(key)")
                        ...
                        if let lazyAttachmentId, base64Data == nil {
                            Task {
                                ...
                                let fallback = FileManager.default.temporaryDirectory
                                    .appendingPathComponent("max-share-probe.\(probeExt.isEmpty ? "png" : probeExt)")
