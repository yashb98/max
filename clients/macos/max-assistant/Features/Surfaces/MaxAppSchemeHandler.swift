...
private let log = Logger(subsystem: Bundle.appBundleIdentifier, category: "MaxAppScheme")

/// Custom URL scheme handler for `maxapp://{uuid}/path` URLs.
...
final class MaxAppSchemeHandler: NSObject, WKURLSchemeHandler {

    /// The scheme this handler manages.
    static let scheme = "maxapp"
    ...
    func webView(_ webView: WKWebView, start urlSchemeTask: WKURLSchemeTask) {
        ...
        // Parse: maxapp://{uuid}/path/to/file
    ...
    private func fail(_ task: WKURLSchemeTask, statusCode: Int, message: String) {
        ...
        let response = HTTPURLResponse(
            url: task.request.url ?? URL(string: "maxapp://error")!,
