...
/// Manages unpacking shared .max bundles into a sandboxed directory.
enum BundleSandbox {
    ...
    static var sharedAppsDirectory: URL {
        ...
        return appSupport
            .appendingPathComponent(MaxEnvironment.current.appSupportDirectoryName)
    ...
    /// Unpacks a `.max` zip file into the sandbox and writes metadata.
