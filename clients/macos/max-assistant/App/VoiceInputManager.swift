...
final class VoiceInputManager {
    ...
    private let engineController = AudioEngineController(label: "com.max.audioEngine.voiceInput")
    ...
    ///
    /// When Max itself is the frontmost app, skip context capture so the
    ...
    private func captureContextAndBeginRecording() {
        ...
        if currentMode == .dictation {
            let isMaxFrontmost = NSWorkspace.shared.frontmostApplication?.bundleIdentifier == Bundle.main.bundleIdentifier
            if !isMaxFrontmost {
