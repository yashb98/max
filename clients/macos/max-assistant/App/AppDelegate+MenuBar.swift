...
/// "Max" right before macOS renders it.  SwiftUI resets the title from
...
extension AppDelegate {
    ...
    func setupMenuBar() {
        ...
        UserDefaults.standard.set(1200, forKey: "NSStatusItem Preferred Position MaxMenuBar")

        statusItem = NSStatusBar.system.statusItem(withLength: NSStatusItem.variableLength)
        statusItem.autosaveName = "MaxMenuBar"
    ...
    /// hatch path, and the existing max CLI retire path.
