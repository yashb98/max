...
/// Builds Max service images from local source code using Docker and loads
...
enum LocalImageBuilder {
    ...
    enum BuildError: LocalizedError {
        ...
        case buildFailed(service: MaxServiceName, output: String)
        case loadFailed(service: MaxServiceName, detail: String)
        ...
        var errorDescription: String? {
            ...
            case .repoRootNotFound:
                return "Could not locate the max-assistant repository root."
    ...
    static func buildConfigs(
        ...
        MaxServiceName.allCases.compactMap { service in
    ...
    private static func buildAndLoadSingleImage(
        ...
        let tmpTar = FileManager.default.temporaryDirectory
            .appendingPathComponent("max-oci-\(config.service.rawValue)-\(uniqueID).tar")
        let tmpDir = FileManager.default.temporaryDirectory
            .appendingPathComponent("max-oci-\(config.service.rawValue)-\(uniqueID)")
