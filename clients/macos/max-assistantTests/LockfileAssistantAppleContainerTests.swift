...
final class LockfileAssistantAppleContainerTests: XCTestCase {
    ...
    func testWritesMgmtSocketWhenProvided() {
        let result = AppleContainersLauncher.writeLockfileEntry(
            ...
            signingKey: "key5",
            mgmtSocket: "/Users/test/Library/Application Support/max-assistant-dev/cli.sock",
            lockfilePath: lockfilePath
        )
        XCTAssertTrue(result)
        ...
        XCTAssertEqual(
            ...
            "/Users/test/Library/Application Support/max-assistant-dev/cli.sock"
        )
    }

    func testMgmtSocketRoundTripsViaLockfileParser() {
        let socketPath = "/Users/test/Library/Application Support/max-assistant-dev/cli.sock"
        AppleContainersLauncher.writeLockfileEntry(
            assistantId: "ac-rt",
            hatchedAt: "2025-08-01T00:00:00Z",
            signingKey: "key9",
