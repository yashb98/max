...
final class ChatViewModelTests: XCTestCase {
    ...
    func testManagedUsageLimitUsesMaxCategory() {
        viewModel.conversationId = "sess-1"

        let errorMsg = ConversationErrorMessage(
            conversationId: "sess-1",
            code: .managedUsageLimit,
            userMessage: "Max managed inference is rate limited.",
            retryable: true,
        ...
        XCTAssertTrue(viewModel.conversationError?.recoverySuggestion.contains("Max-managed") == true)
    }
    ...
    func testProviderBillingCreditsExhaustedIsManagedCreditsExhausted() {
        ...
        let errorMsg = billingConversationErrorMessage(
            userMessage: "Your Max balance has run out.",
        ...
        XCTAssertTrue(error?.recoverySuggestion.contains("Max account") == true)
    }
    ...
    func testConversationManagerViewModelSuppressesManagedCreditsInlineErrorMessage() {
        ...
        XCTAssertEqual(managerViewModel.messages.count, 0)
        XCTAssertEqual(managerViewModel.errorText, "Your Max balance has run out.")
