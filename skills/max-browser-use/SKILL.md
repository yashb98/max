...
1. Install the **Max Assistant Chrome Extension** from the Chrome Web Store: https://chromewebstore.google.com/detail/max-assistant-browser/hphbdmpffeigpcdjkckleobjmhhokpne
