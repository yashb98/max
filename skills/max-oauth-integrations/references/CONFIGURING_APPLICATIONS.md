...
Your user will need to manually create the OAuth application in the third party's web UI. This process is typically more technical in nature. Before embarking on it, check to see if Max supports the provider-of-interest in their managed offerings:
