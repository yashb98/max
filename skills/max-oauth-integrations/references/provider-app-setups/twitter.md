...
The included `max-oauth-integrations` skill handles the generic parts of the flow (credential collection, app registration, connection, and verification). This file defines only the Twitter-specific steps.
...
> 1. **Project name:** `Max Assistant` (or whatever you prefer)
...
>
> Set the app name to **Max Assistant** and click **Next** or **Create**.
...
>    - **Website URL:** You can use `https://max.ai` or any URL you own
...
> `OAUTH_CALLBACK_URL`
>
> For the **Website URL**, you can enter `https://max.ai` or any website you own.
>
> Then click **Save**.
...
> You should see a Twitter consent page asking you to authorize **Max Assistant** to access your account.
>
