...
The included `max-oauth-integrations` skill handles the generic parts of the flow (credential collection, app registration, connection, and verification). This file defines only the Airtable-specific steps.
...
> Set the name to **Max Assistant**. Then click **Register integration**.
...
> I'll start the Airtable authorization flow now. You should see a consent page asking you to allow **Max Assistant** to access your Airtable data.
>
