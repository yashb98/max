...
The included `max-oauth-integrations` skill handles the generic parts of the flow (credential collection, app registration, connection, and verification). This file defines only the Dropbox-specific steps.
...
> 3. **Name your app:** Enter **Max Assistant**
...
- App names must be globally unique on Dropbox - if "Max Assistant" is taken, suggest adding a suffix like "Max Assistant - Personal"
...
> I'll start the Dropbox authorization flow now. You should see a Dropbox consent page asking you to allow **Max Assistant** to access your Dropbox.
>
