...
The included `max-oauth-integrations` skill handles the generic parts of the flow (credential collection, app registration, connection, and verification). This file defines only the Notion-specific steps.
...
>
> 1. Set the name to **Max Assistant**
...
- If they already have an integration named "Max Assistant", ask if they'd like to reuse it - skip ahead to Step 3
...
> 4. Search for **Max Assistant** and select it
