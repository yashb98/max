...
1. **Ask a workspace admin to create the integration** — The admin creates an Internal integration named "Max Assistant", copies the secret token (`ntn_...`), and shares it with the user. The user can then grant it access to their own pages. This is the easiest path.
...
>
> 1. **Ask your admin** to create an Internal integration named "Max Assistant" and share the secret token with you
