...
The included `max-oauth-integrations` skill handles the generic parts of the flow (credential collection, app registration, connection, and verification). This file defines only the Todoist-specific steps.
...
> Set the app name to **Max Assistant** and click **Create app**.
...
> I'll start the Todoist authorization flow now. You should see a Todoist consent page asking you to allow **Max Assistant** to access your account.
>
