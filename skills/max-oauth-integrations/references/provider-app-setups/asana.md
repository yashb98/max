...
The included `max-oauth-integrations` skill handles the generic parts of the flow (credential collection, app registration, connection, and verification). This file defines only the Asana-specific steps.
...
> Set the app name to **Max Assistant**. You'll also need to select a purpose - pick whichever fits best (e.g., "Build an integration" or "Personal use"). Then click **Create app**.
...
> I'll start the Asana authorization flow now. You should see an Asana consent page asking you to allow **Max Assistant** to access your account.
>
