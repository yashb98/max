...
The included `max-oauth-integrations` skill handles the generic parts of the flow (credential collection, app registration, connection, and verification). This file defines only the Spotify-specific steps.
...
> I'll start the Spotify authorization flow now. You should see a Spotify consent page asking you to allow **Max Assistant** to access your account.
>
