...
The included `max-oauth-integrations` skill handles the generic parts of the flow (credential collection, app registration, connection, and verification). This file defines only the Linear-specific steps.
...
> Set the **Application name** to **Max Assistant**.
...
- If the user sees an error about duplicate application names, suggest a variant like "Max Assistant (Personal)"
...
> I'll start the Linear authorization flow now. You should see a Linear consent page asking you to allow **Max Assistant** to access your workspace.
>
