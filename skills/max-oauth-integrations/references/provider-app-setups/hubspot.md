...
The included `max-oauth-integrations` skill handles the generic parts of the flow (credential collection, app registration, connection, and verification). This file defines only the HubSpot-specific steps.
...
> Set the app name to **Max Assistant**. You can leave the other fields (description, logo, etc.) blank for now. Click **Save**.
...
> I'll start the HubSpot authorization flow now. You should see a HubSpot consent page asking you to allow **Max Assistant** to access your account.
>
