...
The included `max-oauth-integrations` skill handles the generic parts of the flow (credential collection, app registration, connection, and verification). This file defines only the GitHub-specific steps.
...
>
> - **Application name:** `Max Assistant`
> - **Homepage URL:** `https://max.ai` (or any URL you prefer)
...
> I'll start the GitHub authorization flow now. You should see a GitHub consent page asking you to allow **Max Assistant** to access your account.
>
