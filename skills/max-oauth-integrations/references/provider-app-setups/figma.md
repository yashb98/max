...
The included `max-oauth-integrations` skill handles the generic parts of the flow (credential collection, app registration, connection, and verification). This file defines only the Figma-specific steps.
...
>
> - **App name:** Max Assistant
> - **Website URL:** any URL is fine (e.g., `https://max.ai`)
>
...
> I'll start the Figma authorization flow now. You should see a Figma consent page asking you to allow **Max Assistant** to access your account.
>
