...
>
> Set the name to **Max Assistant** and click **Create**. Then send me the project ID.
...
>
> 1. **App Information:** Set app name to **Max Assistant**
...
Follow the `max-oauth-integrations` workflow to register the OAuth app, connect, and verify.

Send the returned auth URL to the user. If they see **This app isn't verified**, tell them to click **Advanced** and continue to **Max Assistant**.
