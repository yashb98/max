...
```
python3 /workspace/skills/max-memory-v2-migration/references/buffer-drain.py --dry-run
python3 /workspace/skills/max-memory-v2-migration/references/buffer-drain.py
```
